            ...
            when (response) {
                is Resource.Success -> {
                    ...
                    response.data?.let { newsResponse ->
                        ...
                        val totalPages = (newsResponse.totalResults?.div(QUERY_PAGE_SIZE) ?: 1) + 2
                ...
                is Resource.Error -> {
                    ...
                    response.msg?.let { msg ->
                        ...
                        Toast.makeText(activity, "An error occured: $msg", Toast.LENGTH_SHORT)
                            .show()
                    }
                }
                is Resource.Loading -> {
    ...
    private val scrollListener: RecyclerView.OnScrollListener =
        object : RecyclerView.OnScrollListener() {
            ...
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                val visitItemCount = layoutManager.childCount
                val totalItemCount = layoutManager.itemCount

                val isNotLoadingAndNotLastPage = !isLoading && !isLastPage
                val isAtLastItem = firstVisibleItemPosition + visitItemCount >= totalItemCount
